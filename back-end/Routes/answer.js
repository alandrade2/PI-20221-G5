...
router.get('/assessment/:assessmentId', verifyToken, controller.retrieveByAssessment)
router.get('/question/:questionId', verifyToken, controller.retrieveByQuestion)
